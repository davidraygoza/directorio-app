...
class PhonesControllerTest < ActionController::TestCase
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post :create, phone: { comments: @phone.comments, dependency_id: @phone.dependency_id, name: @phone.name, numbers: @phone.numbers }
    end
  ...
  test "should update phone" do
    put :update, id: @phone, phone: { comments: @phone.comments, dependency_id: @phone.dependency_id, name: @phone.name, numbers: @phone.numbers }
    assert_redirected_to phone_path(assigns(:phone))
  end
